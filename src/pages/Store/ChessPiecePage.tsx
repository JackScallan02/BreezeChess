...
const ChessPieceBlock = ({ item, isFeatured }: { item: { name: string; price: number; description: string, image: string }; isFeatured?: boolean; }) => {
    ...
    return (
        <div className={`${CHESS_PIECE_ITEM.name === item.name && 'md:h-full md:max-h-[70vh]'} bg-white dark:bg-slate-800 p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col items-center`}>
