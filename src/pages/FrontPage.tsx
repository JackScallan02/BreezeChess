        ...
        <div className="flex flex-col">
          <div className="">
            ...
            <div className="flex justify-center">
              <p className="dark:text-white lg:text-2xl tracking-tight text-center m-12 lg:leading-[2] text-[2.5vh] leading-[2] w-[90%] md:w-[70%]">
          ...
          <div className="flex justify-center h-full mt-10 border border-gray-300 dark:border-gray-800">
            <div className="bg-sky-200 bc-dark-bg-light w-full">
              ...
              <div className="flex flex-row justify-center">
                <p className="dark:text-white lg:text-2xl tracking-tight text-center m-12 lg:leading-[2] text-[2.5vh] leading-[2] w-[90%] md:w-[50%]">
